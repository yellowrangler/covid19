controllers.resourcesController = function ($scope, $http, $location, nflTeamsService, teamsFactory, membersFactory, loginService) {
    ...
    function init() {
        $(window).scroll(function(){
            if ($(".floatingImgDiv").length)
            {
                ...
                var footerTopPos = $('.covid-footer').offset().top;
