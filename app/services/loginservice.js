covid19App.service('loginService', function () {
    ...
    this.saveLogin = function (loginStr) {
        localStorage.removeItem("covidLogin");
        localStorage.setItem("covidLogin", loginStr);
    }

    this.retreiveLogin = function () {
        var loginStr = localStorage.getItem("covidLogin");
