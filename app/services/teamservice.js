covid19App.service('nflTeamsService', function () {
    ...
    this.saveCurrentSeason = function (currentSeasonStr) {
        localStorage.removeItem("covidCurrentSeason");
        localStorage.setItem("covidCurrentSeason", currentSeasonStr);
    }

    this.retreiveCurrentSeason = function () {
        var currentSeasonStr = localStorage.getItem("covidCurrentSeason");
    ...
    this.saveCurrentWeek = function (currentWeekStr) {
        localStorage.removeItem("covidCurrentWeek");
        localStorage.setItem("covidCurrentWeek", currentWeekStr);
    }

    this.retreiveCurrentWeek = function () {
        var currentWeekStr = localStorage.getItem("covidCurrentWeek");
